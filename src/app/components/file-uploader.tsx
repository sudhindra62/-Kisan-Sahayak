    ...
    <div className="w-full flex flex-col">
      <div {...getRootProps()} className={containerClasses}>
        ...
        <div className="w-full flex flex-col items-center">
            <span className="text-xs font-semibold uppercase tracking-wider text-white/50 mb-3 text-center w-full block truncate">
            ...
            <div className="file-preview">
                ...
                <FileIcon className="h-5 w-5 mr-3 text-slate-400 shrink-0" />
            ...
            <div className="uploader-idle-content">
                ...
                <p className="text-xs text-white/60">Drop file or click</p>
            </div>
            )}
        </div>
      </div>
